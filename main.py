...
def oneSureNum(imagePath): # 得到最可靠的数字以及其中心位置，并画掉原来的数字
    ...
    for i in range(10):
        oneNumArray.append(difTowPic(imagePath,"./template/"+str(i)+".jpg"))
...
def getPhoneNumber(url):
    ...
    os.remove("./test/1.tif")
    return phoneNumber1 + "," + phoneNumber2

# print getPhoneNumber(str(sys.argv[1]))
print getPhoneNumber(str(r"http://image.58.com/showphone.aspx?t=v55&v=390EB134967C595F24A56BE6A5F370487"))
